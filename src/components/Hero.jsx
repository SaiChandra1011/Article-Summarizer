...
<header className="w-full flex justify-center items-center flex-col">
  ...
  <h2 className="description pt-8">SummarAI leverages the cutting-edge OpenAI GPT-4 technology to provide concise and insightful summaries of articles. SummarAI gives users  a seamless experience, effortlessly grasping the essence of lengthy articles with just a few clicks. Experience the future of article summarization with SummarAI.</h2>
</header>
