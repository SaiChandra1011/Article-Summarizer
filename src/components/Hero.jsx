...
<header className="w-full flex justify-center items-center flex-col">
  ...
  <h1 className="head_text">Summarize Articles with <br className="max-md:hidden" /> <span className="dark_blue_gradient" >OpenAI GPT-4</span></h1>
  <h2 className="description pt-8">SummarAI leverages the cutting-edge OpenAI GPT-4 technology to provide concise and insightful summaries of articles. At SummarAI, users encounter a seamless experience, effortlessly grasping the essence of lengthy articles with just a few clicks. Experience the future of article summarization with SummarAI.</h2>
</header>
...
<nav className='flex justify-between items-center w-full mb-28 pt-2'>
  ...
  <button type="button" onClick={() => window.open("https://github.com/SaiChandra1011/Article-Summarizer")} className="black_btn" >
    GitHub Code
    </button>
  <button type="button" onClick={() => window.open("https://github.com/SaiChandra1011/Article-Summarizer")} className="black_btn" >
    GitHub Code
